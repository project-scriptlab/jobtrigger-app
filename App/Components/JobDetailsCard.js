                                ...
                                <View>
                                    <RenderHtml
                                        ...
                                        tagsStyles={{
                                            ...
                                            thead: { backgroundColor: colors.darkBlue, color: Colors.white, borderWidth: 0.2, borderColor: colors.darkBlue, fontFamily: FONTS.semibold },
                                            th: { backgroundColor: colors.darkBlue, color: Colors.white, borderWidth: 0.2, borderColor: Colors.lightBlck, padding: 2, paddingLeft: 5, paddingVertical: 4, fontFamily: FONTS.medium },
